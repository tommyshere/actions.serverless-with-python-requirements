...
class DomainConfig {
    constructor(config) {
        ...
        this.baseStage = globals_1.default.getBaseStage();
        this.stage = config.stage || globals_1.default.getBaseStage();
    ...
    _getBasePath(basePath) {
        ...
        if (globals_1.default.reservedBasePaths.indexOf(basePath) !== -1) {
            globals_1.default.logWarning("The `/ping` and `/sping` paths are reserved for the service health check.\n Please take a look at" +
                "https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-known-issues.html");
        }
        return basePath;
    }
    _getEndpointType(endpointType) {
    ...
    _getTLSTruststoreUri(tlsTruststoreUri, endpointType) {
        if (tlsTruststoreUri) {
    ...
    _getSecurityPolicy(securityPolicy) {
    ...
    _getRoute53Params(route53Params, endpointType) {
        var _a, _b, _c;
