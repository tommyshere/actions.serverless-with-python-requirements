...
class CloudFormationWrapper {
    constructor(credentials) {
        ...
        this.stackName = globals_1.default.serverless.service.provider.stackName ||
            `${globals_1.default.serverless.service.service}-${globals_1.default.getBaseStage()}`;
    }
    /**
    ...
    getCloudformationId(apiGatewayValue, apiType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (importName) {
                ...
                if (!nameValue) {
                    globals_1.default.logWarning(`CloudFormation ImportValue '${importName}' not found in the outputs`);
                }
                return nameValue;
            }
            ...
            if (ref) {
                try {
                    ...
                    globals_1.default.logWarning(`Unable to get ref ${ref} value.\n ${error.message}`);
                    return null;
                }
            }
            // log warning not supported restApiId
            globals_1.default.logWarning(`Unsupported apiGateway.${apiType} object`);
            return null;
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const name of filteredStackNames) {
                try {
                    ...
                    globals_1.default.logWarning(err.message);
                }
            }
            return response;
        });
